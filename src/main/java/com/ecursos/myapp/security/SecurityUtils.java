...
import com.ecursos.myapp.config.Constants;
...
public final class SecurityUtils {
    ...
    public static String getFabNrOrdem(Authentication authentication) {
        if (authentication instanceof OAuth2AuthenticationToken) {
            OAuth2AuthenticationToken oauthToken = (OAuth2AuthenticationToken) authentication;
            Map<String, Object> attributes = oauthToken.getPrincipal().getAttributes();
            
            if (attributes.containsKey("fabnrordem")) {
                return attributes.get("fabnrordem").toString();
            }
        }
        return null;
    }
    ...
    public static Map<String, Object> extractDetailsFromTokenAttributes(Map<String, Object> attributes) {
        ...
        Optional.ofNullable(attributes.get("displayname")).ifPresent(displayname -> details.put("displayname", displayname));
        Optional.ofNullable(attributes.get("fabnrordem")).ifPresent(fabnrordem -> details.put("fabnrordem", fabnrordem));
