...
<@layout.registrationLayout displayInfo=true; section>
            ...
            <div class="${properties.kcFormGroupClass!} row">
                <div id="kc-form-options" class="${properties.kcFormOptionsClass!} col-xs-5">
                    <div class="${properties.kcFormOptionsWrapperClass!}">
                        <span>
                            <a class="btn btn-default btn-flat btn-block" href="${url.loginUrl}"><i class="fa fa-caret-left"></i>&nbsp;&nbsp;Voltar</a>
                        </span>
                    </div>
                </div>
    ...
    <#elseif section = "info" >
        ...
        <div class="alert alert-warning">
            Para usuários que utilizam o login único da FAB, é necessário fazer a recuperação da senha diretamente pelo site do Portal do Militar.
        </div>
    </#if>
