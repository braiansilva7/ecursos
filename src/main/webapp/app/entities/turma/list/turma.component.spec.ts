...
import { sampleWithRequiredData } from '../turma.test-samples';
...
describe('Turma Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to turmaService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTurmaIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTurmaIdentifier).toHaveBeenCalledWith(entity);
