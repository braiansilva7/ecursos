...
import tipoResolve from './tipo-routing-resolve.service';

describe('Tipo routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: TipoService;
  let resultTipo: ITipo | null | undefined;
  ...
  describe('resolve', () => {
    it('should return ITipo returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        tipoResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
            resultTipo = result;
          },
        });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultTipo).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ITipo>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
