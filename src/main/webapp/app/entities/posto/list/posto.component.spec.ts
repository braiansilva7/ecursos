...
import { sampleWithRequiredData } from '../posto.test-samples';
import { PostoService } from '../service/posto.service';

import { PostoComponent } from './posto.component';
import SpyInstance = jest.SpyInstance;

describe('Posto Management Component', () => {
  let comp: PostoComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(PostoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.postos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to postoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPostoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPostoIdentifier).toHaveBeenCalledWith(entity);
