...
public class CursoAsserts {
    ...
    public static void assertCursoUpdatableFieldsEquals(Curso expected, Curso actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getCursoNome()).as("check cursoNome").isEqualTo(actual.getCursoNome()))
            .satisfies(e -> assertThat(e.getCursoSigla()).as("check cursoSigla").isEqualTo(actual.getCursoSigla()))
